...
static const char qt_meta_stringdata_ColorDiagram[] = {
    "ColorDiagram\0\0position\0"
...
const QMetaObjectExtraData ColorDiagram::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ColorDiagram::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ColorDiagram,
      qt_meta_data_ColorDiagram, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ColorDiagram::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorDiagram))
